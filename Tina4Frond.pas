...
type
  ...
  /// continues to work unchanged — it's the same class as TTina4Frond.</summary>
  TTina4Twig = TTina4Frond;
...
/// </remarks>
function TTina4Frond.Tokenize(const Expr: String): TArray<String>;
var
  Tokens: TList<String>;
  I: Integer;
  Token: String;
...
/// </remarks>
function TTina4Frond.InfixToRPN(const Tokens: TArray<String>): TArray<String>;
var
  Output: TList<String>;
...
/// </remarks>
function TTina4Frond.EvaluateRPN(const RPN: TArray<String>; const Context: TDictionary<String, TValue>): TValue;
var
  Stack: TStack<TValue>;
  Token: String;
  A, B: TValue;
...
/// </remarks>
function TTina4Frond.EvaluateExpression(const Expr: String; Context: TDictionary<String, TValue>): TValue;
var
...
/// </remarks>
function TTina4Frond.GetExpressionValue(const Expr: String; Context: TDictionary<String, TValue>): TValue;
var
...
function TTina4Frond.GetVariable(AName: String): TValue;
begin
  try
...
/// <summary>
/// Initializes a new instance of the TTina4Frond class.
/// </summary>
...
/// </remarks>
constructor TTina4Frond.Create(const TemplatePath: String);
begin
  inherited Create;
  FDebug := False;
...
/// </remarks>
procedure TTina4Frond.DumpValue(const Value: TValue; List: TStringList; const Indent: String);
var
  Arr: TArray<TValue>;
  Dict: TDictionary<String, TValue>;
...
/// </remarks>
function TTina4Frond.RemoveComments(const Template: String): String;
var
  Regex: TRegEx;
begin
...
/// </remarks>
function TTina4Frond.ValuesAreEqual(const A, B: TValue): Boolean;
var
...
/// </remarks>
function TTina4Frond.Contains(const Left, Right: TValue): Boolean;
var
  Arr: TArray<TValue>;
  v: TValue;
  Dict: TDictionary<String, TValue>;
...
function TTina4Frond.ConvertJSONToTValue(const JSON: TJSONValue): TValue;
var
  Dict: TDictionary<String, TValue>;
  Arr: TArray<TValue>;
  I: Integer;
...
/// </remarks>
function TTina4Frond.ToBool(const Value: TValue): Boolean;
begin
  if Value.IsEmpty then
    Exit(False);
...
/// </remarks>
function TTina4Frond.EvaluateMacroBlocks(const Template: String; Context: TDictionary<String, TValue>): String;
var
  Regex: TRegEx;
  Match: TMatch;
...
function TTina4Frond.IsStrictNumeric(const Value: TValue): Boolean;
var
  Dummy: Double;
begin
  case Value.Kind of
...
function TTina4Frond.GetAsExtendedLenient(const Value: TValue): Extended;
var
  dt: TDateTime;
begin
...
function TTina4Frond.CompareValues(const Left, Right: TValue; const Op: String): Boolean;
var
...
/// </remarks>
function TTina4Frond.ResolveVariablePath(const VariablePath: string; Context: TDictionary<String, TValue>): TValue;
var
  Regex: TRegEx;
...
/// </remarks>
function TTina4Frond.LoadTemplate(const TemplateName: String): String;
var
...
/// </remarks>
function TTina4Frond.ParseVariableDict(const DictStr: String; OuterContext: TDictionary<String,TValue>): TDictionary<String,TValue>;
var
  Content: String;
...
procedure TTina4Frond.RegisterDefaultFilters;
begin
  FFilters.Clear;
...
procedure TTina4Frond.RegisterDefaultFunctions;
begin
  FFunctions.Add('dump',
...
/// </remarks>
function TTina4Frond.Render(const TemplateOrContent: String; Variables: TStringDict = nil): String;
var
  LocalContext: TDictionary<String, TValue>;
begin
  LocalContext := TDictionary<String, TValue>.Create;
...
/// </remarks>
procedure TTina4Frond.ProcessTemplate(const Template: String; var LocalContext: TDictionary<String, TValue>; var Result: String);
type
  TBranch = record
    Condition: String;
    Body: String;
...
/// </remarks>
procedure TTina4Frond.SetVariable(AName: string; AValue: TValue);
var
