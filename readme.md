...
**Click methods** — the click endpoint supports three modes, from most to least reliable:
...
**Preview Bridge setup** — add to `.claude/launch.json` in your project root:
...
```
compile_pascal(source, compiler="C:\\Program Files (x86)\\Embarcadero\\Studio\\23.0\\bin\\dcc64.exe")
```
